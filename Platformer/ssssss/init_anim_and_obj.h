...
void init_map_objects(std::vector<Object> &e, std::list<Entity*> &entities, AnimationManager &anim_clon_enemy, AnimationManager &anim_droid_enemy, AnimationManager &anim4, Level &lvl, AnimationManager &anim_health)
{
...
void init_texture(Texture &enemy_droid, Texture &moveplatform, Texture &anakin, Texture &fang, Texture &enemy_clon, Texture &fire, Texture &bonus)
{
...
{
	musicInMenu.openFromFile("sound/music.ogg");
	shootBuffer.loadFromFile("sound/lazer.ogg");
	saberBuffer.loadFromFile("sound/saberdown.ogg");
	musicInGame.openFromFile("sound/game.ogg");
}