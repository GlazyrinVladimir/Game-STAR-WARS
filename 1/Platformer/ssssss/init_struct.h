...
struct init_texture
{
	...
	AnimationManager anim_shield_l;
	AnimationManager anim_choke;
	...
	init_texture()
	{
		...
		shield_left.loadFromFile("files/shield.png");
		texture_chock.loadFromFile("files/kek.png");
		...
		trainingBack.loadFromFile("files/faq.png");
		...
		anim_shield_l.create("stay", shield_left, 0, 0, 61, 70, 1, 0);
		anim_choke.create("move", texture_chock, 0, 0, 30, 30, 1, 0);
