...
struct init_sounds
{
	...
	init_sounds()
	{
		...
		levelThird.openFromFile("thirdLevel.ogg");
		shootBuffer.loadFromFile("lazer.ogg");
		saberBuffer.loadFromFile("saberdown.ogg");
		musicInGame.openFromFile("game.ogg");
		deathClonBuffer.loadFromFile("pain1.ogg");
		deathDroidBuffer.loadFromFile("light.ogg");
		deathEnakinBuffer.loadFromFile("dead.ogg");
		deathObiBuffer.loadFromFile("dead_obi.ogg");
