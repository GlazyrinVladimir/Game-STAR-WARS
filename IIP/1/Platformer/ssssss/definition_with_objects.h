...
void is_enemy_alive(std::list<Entity*>::iterator &it, std::list<Entity*> &entities, float &time, Level lvl, AnimationManager anim_mana, int &dead_enemy, Sound &deathClon, Sound &deathDroid)
{
